...
var states = [
        ...
        { name: 'new-list', state: { url: '/new-list', parent: 'lists', templateUrl: 'views/dashboard/new-list.html', data: {text: "New List", visible: false } } },
        ...
        { name: 'new-vote', state: { url: '/new-vote', parent: 'votes', templateUrl: 'views/dashboard/new-vote.html', data: {text: "New Vote", visible: true } } },
